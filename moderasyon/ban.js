...
exports.run = async(client, message, args) => {
	...
	if(!message.member.roles.cache.has(rol)&& !message.member.hasPermission("BAN_MEMBERS")) return message.channel.send('**Ban atmak için `Yönetici` yetkisine sahip olmalısın**.')
